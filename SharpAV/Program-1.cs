...
namespace SharpAV
{
    class Program
    {
        ...
        public static void AVDetection()
        {
            ...
            av_list.Add("ccsvchst.exe", "symantec(赛门铁克) 或 norton(诺顿杀毒)");
            av_list.Add("rtvscan.exe", "symantec(赛门铁克) 或 norton(诺顿杀毒)");
            av_list.Add("smc.exe", "symantec(赛门铁克)");
            av_list.Add("smcgui.exe", "symantec(赛门铁克)");
            av_list.Add("snac.exe", "symantec(赛门铁克)");
			av_list.Add("symcorpui.exe", "symantec(赛门铁克)");
            ...
            av_list.Add("msascui.exe", "windows defender");
            av_list.Add("msascuil.exe", "windows defender");
            av_list.Add("securityhealthservice.exe", "windows defender");	
			...
			Console.WriteLine("ProcessName" + "			" + "Description");
			Console.WriteLine("-----------" + "			" + "-----------");
