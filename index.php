...
if(isset($_POST["input_process"])){
	...
	// 从文件中读取数据到PHP变量
	$json_string = file_get_contents('ProcessList.json');
	// JSON字符串转数组
...
<form class="am-form" method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
  <fieldset>
    <div class="am-form-group">
      <textarea class="" rows="7" id="doc-ta-1" name="input_process"></textarea>
    </div>
...
<footer data-am-widget="footer" class="am-footer am-footer-default" data-am-footer="{  }">
  <div class="am-footer-miscs ">
    <p>由
      <a href="https://www.se7ensec.cn/" title="Se7en" target="_blank">Se7en </a>提供技术支持 <a href="https://github.com/r00tSe7en/get_AV"> | Github</a></p><br/>
